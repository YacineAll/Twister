...
public class USER_DB {
	...
	/**
	 * Verfie l'existance d'un utilisateur dans la base de donnee USER à partir de son login 
	 * 
	...
	/**
	 * Verifie le mot de passe passe en parametre de l'utilisateur login correspond a celui qui est dans la base USER 
	 * 
	 * @param login le login de l'utiisateur c'est un String
	 * @param password le mot de passe de l'utilsateur c'est un String 
	 * @return boolean true si le mot de passe correspond a celui qui est dans la base USER 
	...
	/**
	 * Retourne l'identifiant de l'utilsateur qui a pour login le login passe en parametre
	 * 
	 * @param login le login de l'utiisateur c'est un String
	...
	/**
	 * Ajoute un user a la base de donnee user, il y'a des contraintes : il faut que le login n'existe pas deja 
	 * il faut qui'il soit unique 
	 * 
	 ...
	 * @throws SQLException erreur de connexion a la basse de donnee 
	 */
	...
	/**
	 * Retourne un JASONObject qui a le nom et le prenom de l'utilisateur qui a l'identifiant id
	 * 
	 * @param idUser int l'identifiant de l'utilisateur
	 * @return JSONObject {"nom":nomUser;"prenom":prenomUser} sont les deux des String
	 * @throws SQLException
	 */
