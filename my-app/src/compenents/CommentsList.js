...
import {
    List, Avatar, Tooltip, Popconfirm, Icon, Button
} from 'antd';
            ...
            <List.Item key={item.id} 
                actions={[
                            <Popconfirm title="Are you sure？" icon={<Icon type="question-circle-o" style={{ color: 'red' }} />}>
                                <Button type="danger" size="small" icon="delete" onClick={(event) => onDelete(item.idComment)}>Delete</Button>
                            </Popconfirm>
                        ]} 
            >
                <List.Item.Meta
